...
Shader "Custom/MasterShader"
{
	Properties
	{
		...
		_RougnessIntensityBoost("Rougness Intensity Boost", Range( 0 , 2)) = 0
		_MetallicIntensityBoost("Metallic Intensity Boost", Range( 0 , 2)) = 0
		_AOIntensityBoost("AO Intensity Boost", Range( 0 , 2)) = 0
	...
	SubShader
	{
		...
		uniform float _MetallicIntensityBoost;
		uniform float _RougnessIntensityBoost;
		uniform float _AOIntensityBoost;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Metallic = ( tex2DNode3.r * _MetallicIntensityBoost );
			float temp_output_9_0 = ( tex2DNode3.g * _RougnessIntensityBoost );
			...
			o.Occlusion = ( tex2DNode3.b * _AOIntensityBoost );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18917
984;73;935;665;585.5139;-244.0739;1;True;False
Node;AmplifyShaderEditor.Vector2Node;17;-1251.677,514.8836;Inherit;False;Property;_Offset;Offset;7;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;18;-1038.677,542.8836;Inherit;False;Property;_Tilling;Tilling;8;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-220.3495,425.021;Inherit;False;Property;_RougnessIntensityBoost;Rougness Intensity Boost;4;0;Create;True;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-221.3495,789.021;Inherit;False;Property;_AOIntensityBoost;AO Intensity Boost;6;0;Create;True;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-111.3495,558.021;Inherit;False;Property;_MetallicIntensityBoost;Metallic Intensity Boost;5;0;Create;True;0;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=64BF4579604AF7BE35B7CEAA89FFF9E37827950B